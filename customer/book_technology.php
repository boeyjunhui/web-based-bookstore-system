...
<body>
    ...
    <div class="book-category">
        <div class="container">
            <div class="row">
                <h1 class="text-center mt-5 mb-5" style="color: white;">Technology</h1>
            </div>
        </div>
    </div>
    ...
    <div class="single-product-area">
        <div class="container">
            <div class="row">
                ...
                $query = "SELECT * FROM book WHERE Category = 'Technology'";
                ...
                ?>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="single-shop-product">
                                <form action="book_technology.php" method="POST" enctype="multipart/form-data">
                                ...
                                <form action="book_technology.php" method="POST">
                                    ...
                                    if (isset($_POST['add_to_cart_btn'])) {
                                        ...
                                        if (($quantity > 0 && $quantity > $row['StockQuantity']) && filter_var($quantity, FILTER_VALIDATE_INT) && ($row['BookID'] == $id && $row['StockQuantity'] != 0)) {
                                            ...
                                            '<script>
                                                ...
                                                window.location.href="book_technology.php";
                                            </script>';
