...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Generate
                <small>sales order report</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href=""><i class="active">Generate Sales</i></a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Generate Sales Order</h3>
                        </div>
            <!-- Small boxes (Stat box) -->
            <div class="panel-body">
				<form class="form-horizontal" action="php_action/order/generate_sale_report.php" method="post" id="getSalesReportForm">
				  ...
				  <div class="form-group">
				    <div class="col-sm-offset-1 col-sm-10">
				      <button type="submit" class="btn btn-success" id="generate_order_report_btn"> <i class="glyphicon glyphicon-ok-sign"></i> Generate Report</button>
				    </div>
				  </div>
				</form>
